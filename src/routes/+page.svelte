...
<div class="container-xl my-5 pt-3">
  ...
  <div class="row mt-4 g-4" style="display: none;">
    <div class="col-sm-6 col-md-4 wow animate__fadeInUp">
      <div class="card shadow">
        <img class="card-img-top" src="/sample_med.jpg" />
        <div
          class="card-body"
          style="background: linear-gradient(157.59deg, hsla(0, 0%, 100%, 0.1) -2.85%, rgba(87, 67, 143, 0.1) 89.86%)"
        >
    ...
    <div class="col-sm-6 col-md-4 wow animate__fadeInUp">
      <div class="card shadow">
        ...
        <div
          class="card-body"
          style="background: linear-gradient(139deg, rgba(186, 215, 0, 0.247) 0%, rgba(94, 192, 205, 0.384) 100%)"
        >
          <h5 class="card-title">Gabadron-Plus</h5>
          <h6 class="text-body-secondary">Pregabaline 75 mg, Nortriptyline Hydrochloride 10mg</h6>
          <p class="card-text text-body-secondary small">
    ...
    <div class="col-sm-6 col-md-4 wow animate__fadeInUp">
      <div class="card shadow text-bg-light">
        <img class="card-img-top" src="/sample_med.jpg" />
        <div class="card-body">
          <h5 class="card-title">Gabadron-Plus</h5>
          <h6 class="text-body-secondary">Pregabaline 75 mg, Nortriptyline Hydrochloride 10mg</h6>
    ...
    <div class="col-sm-6 col-md-4 wow animate__fadeInUp">
      <div class="card shadow text-bg-light">
        ...
        <div class="card-body">
          ...
          <div class="mt-4 d-flex align-items-center">
            <!-- <div class=""><a href="#" class="fw-semibold text-dark text-decoration-none stretched-link">Read more ></a></div> -->
            <a data-fslightbox href="#product" class="card-link stretched-link" data-class="lightbox-on"
              >&nbsp; Read more</a
            >
            <!--  <a
                  class="btn stretched-link btn-outline-success p-0 pe-2 rounded-2 text-nowrap"
